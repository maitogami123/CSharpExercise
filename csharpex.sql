...
TenBangCap nvarchar(40) NULL, CONSTRAINT PK_BANGCAP PRIMARY KEY (MaBangCap)
)
GO
--Tạo bảng Nhân viên 
...
MaPhieuThuTien int Identity(1,1), SoTienNo float NULL, SoTienThu float NULL, MaDocGia int NULL,
MaNhanVien int NULL,
...
TriGia float NULL,
NgayNhap datetime NULL, CONSTRAINT PK_SACH PRIMARY KEY (MaSach)
) GO
...
ALTER TABLE PHIEUMUONSACH	WITH CHECK ADD	CONSTRAINT FK_PHIEUMUONSACH_DOCGIA FOREIGN KEY(MaDocGia) REFERENCES DOCGIA (MaDocGia)
ON UPDATE CASCADE ON DELETE CASCADE GO
ALTER TABLE PHIEUMUONSACH CHECK CONSTRAINT FK_PHIEUMUONSACH_DOCGIA GO
ALTER TABLE CHITIETPHIEUMUON	
WITH CHECK ADD	CONSTRAINT FK_CHITIETPHIEUMUON_PHIEUMUONSACH FOREIGN KEY(MaPhieuMuon) REFERENCES PHIEUMUONSACH (MaPhieuMuon)
GO
ALTER TABLE CHITIETPHIEUMUON CHECK CONSTRAINT FK_CHITIETPHIEUMUON_PHIEUMUONSACH
GO
ALTER TABLE CHITIETPHIEUMUON	WITH CHECK ADD	CONSTRAINT FK_CHITIETPHIEUMUON_SACH FOREIGN KEY(MaSach) REFERENCES SACH (MaSach)
ON UPDATE CASCADE ON DELETE CASCADE GO
...
delete from NHANVIEN where HoTenNhanVien = '0'
